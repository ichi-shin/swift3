...
class Swift3TestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.app.register('TEST', '/v1/AUTH_test', swob.HTTPMethodNotAllowed,
                          {}, None)
        self.app.register('TEST', '/v1/AUTH_X', swob.HTTPMethodNotAllowed,
                          {}, None)
...
class TestSwift3Middleware(Swift3TestCase):
    ...
    def setUp(self):
        ...
        self.app.register('GET',
                          '/v1/AUTH_X/bucket+segments/object/123456789abcdef',
                          swob.HTTPOk,
                          {'x-object-meta-[swift3]-acl': '["X:Y"]'},
                          private_acl)
        ...
        self.app.register('HEAD', '/v1/AUTH_X/bucket', swob.HTTPNoContent,
                          {'x-timestamp': 0,
                           'x-container-sysmeta-swift3-acl': '["X:Y"]'}, None)
        self.app.register('GET', '/v1/AUTH_X/bucket', swob.HTTPOk,
                          {'x-timestamp': 0,
                           'x-container-sysmeta-swift3-acl': '["X:Y"]'}, '[]')
    ...
    @patch('swift3.cfg.CONF.storage_domain', None)
    def test_virtual_hosted_style_without_storage_domain(self):
        ...
        self.assertTrue(('GET', '/v1/AUTH_X?format=json') in self.app.calls)

    @patch('swift3.cfg.CONF.storage_domain', '.localhost')
