...
from swift3.acl import LifecycleConf
...
class TestSwift3Lifecycle(Swift3TestCase):
    ...
    def setUp(self):
        ...
        self.app.register('GET',
                          '/v1/.swift3/lifecycle_rules?format=json'
                          '&prefix=AUTH_test/junk_deleted/0',
                          swob.HTTPOk, {},
                          json.dumps([{'name': 'AUTH_test/junk_deleted/0/'
                                       '0000000001.00000',
                                       'last_modified':
                                       '2014-05-07T19:47:54.592270',
                                       'hash': 'Y',
        ...
        self.app.register('GET', '/v1/.swift3/acl/AUTH_test/junk/0/a1/0',
                          swob.HTTPNotFound, {}, None)
        self.app.register('GET', '/v1/.swift3/acl/AUTH_test/junk/0/b1/0',
                          swob.HTTPNotFound, {}, None)
        ...
        self.app.register('GET',
                          '/v1/.swift3/lifecycle_rules/AUTH_test/junk/0/'
                          '0000000001.00000',
                          swob.HTTPOk, {}, conf_xml)
        self.app.register('GET',
                          '/v1/.swift3/lifecycle_rules/AUTH_test/'
                          'junk_deleted/0/0000000001.00000',
                          swob.HTTPOk, {}, '<LifecycleConfiguration/>')
    ...
    def test_object_expirer_bucket_ts_differ(self):
        wsgi.loadapp = lambda *a, **kw: self.app
        conf = {
            'log_level': 'debug',
        }
        ...
        self.app.register('GET',
                          '/v1/AUTH_test/junk?format=json',
                          swob.HTTPOk,
                          {'x-container-meta-[swift3]-timestamp': 1},
                          None)
    ...
    def test_object_expirer_lifecycle_not_found(self):
        wsgi.loadapp = lambda *a, **kw: self.app
        conf = {
            'log_level': 'debug',
        }
    ...
    def test_object_expirer_object_rules_fail_delete(self):
        wsgi.loadapp = lambda *a, **kw: self.app
        conf = {
            'log_level': 'debug',
        }
    ...
    def test_object_GET_expired(self):
        req = Request.blank('/junk/a1',
    ...
    def test_same_id_rules(self):
        self.assertRaises(InvalidArgument, LifecycleConf, xml=conf_same_id_xml)

    def test_overlapping_prefixes_rules(self):
        self.assertRaises(InvalidRequest, LifecycleConf,
